   ...
   begin
      if defined?(Impression)
        if browser.bot?
          ...
          impressionist @app_site unless @app_site.nil? || (controller_name == "books" && action_name == "update") || (controller_name == 'admin' && action_name == 'html_diff') || (controller_name == 'books' && action_name == 'cover')
        end     
      end
